...
int main() {
    ...
    LOG(INFO) << "RMX1901 Power HAL AIDL Service with Extension is starting with config: "
              << config_path;
    ...
    LOG(INFO) << "RMX1901 Power HAL AIDL Service with Extension is started.";
    ...
    // should not reach
    LOG(ERROR) << "RMX1901 Power HAL AIDL Service with Extension just died.";
    return EXIT_FAILURE;
}
